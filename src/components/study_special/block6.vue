        ...
        <div class="flex-1 pr flex-col scrollbar" style="margin:10px;">
            <div class="rank_list">
                <el-table :data="data" style="width: 100%" class="comTable dangyuanpaihang">
                    ...
                    <el-table-column prop="realname" label="党员排行" show-overflow-tooltip></el-table-column>
                    <el-table-column prop="count" label="参与次数" width="60" align="center"></el-table-column>
                </el-table>
            </div>
        </div>
    </div>
...
export default {
    ...
    methods: {
        getData: function(){
            home.studymemberrank(this.queryParam).then(res => {
...
.dangyuanpaihang th:first-child > .cell,.dangyuanpaihang th:nth-child(3) > .cell { padding:0;}
