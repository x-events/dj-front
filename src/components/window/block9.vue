<template>
    <div class="block_wrap_opc withTitle flex-col vbHidden" :class="{'animated fadeInRight faster delay4':animate == 1,'animated fadeOutRight faster':animate == 2}">
        <div class="channelBar red" @click="$router.push({name:'主题党日活动'})">
