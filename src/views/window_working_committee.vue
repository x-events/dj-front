        ...
        <el-header height="300px" class="flex-col">
            <div class="block_wrap_opc flex-1 flex-col nodot">
                ...
                <div class="flex-row flex-1">
                    <div class="flex-1 dotBox chartBox mr20"><b class="dot"></b>
                    ...
                    <div class="flex-1 flex-col counter">
                        <div class="flex-1 flex-row ">
                            <div class="flex-1 dotBox flex-row align-center"><b class="dot"></b>
                                <div class="flex-1">
                                    <div class="count">{{countData.data.avg_count}}</div>
                                    <div class="text">均件受益人数量</div>
                                </div>
                            </div>
                            <div class="flex-1 dotBox flex-row align-center" v-if="countData.types[0]"><b class="dot"></b>
                                <div class="flex-1">
                                    <div class="count">{{countData.types[0].count}}</div>
                                    <div class="text">{{countData.types[0].title}}</div>
                                </div>
                            </div>
                        </div>
                        <div class="flex-1 flex-row">
                            <div class="flex-1 dotBox flex-row align-center" v-if="countData.types[1]"><b class="dot"></b>
                                <div class="flex-1">
                                    <div class="count">{{countData.types[1].count}}</div>
                                    <div class="text">{{countData.types[1].title}}</div>
                                </div>
                            </div>
                            <div class="flex-1 dotBox flex-row align-center" v-if="countData.types[2]"><b class="dot"></b>
                                <div class="flex-1">
                                    <div class="count">{{countData.types[2].count}}</div>
                                    <div class="text">{{countData.types[2].title}}</div>
                                </div>
                            </div>
                        </div>
                        <div class="flex-1 flex-row">
                            <div class="flex-1 dotBox flex-row align-center" v-if="countData.types[3]"><b class="dot"></b>
                                <div class="flex-1">
                                    <div class="count">{{countData.types[3].count}}</div>
                                    <div class="text">{{countData.types[3].title}}</div>
                                </div>
                            </div>
                            <div class="flex-1 dotBox flex-row align-center" v-if="countData.types[4]"><b class="dot"></b>
                                <div class="flex-1">
                                    <div class="count">{{countData.types[4].count}}</div>
                                    <div class="text">{{countData.types[4].title}}</div>
                                </div>
                            </div>
                        </div>
                    </div>
...
export default {
    ...
    methods: {
        ...
        getData() {
            ...
            home.dogoodbranch(this.queryParam).then(res => {
...
.counter .count { font-size:24px; color:#ffeb08;}
.counter .count .unit { font-size:16px;}
.counter > .flex-row { margin-bottom:10px;}
.counter > .flex-row:last-child { margin-bottom:0;}
.counter > .flex-row > [class *= "flex-"] { margin-right:10px;}
.counter > .flex-row > [class *= "flex-"]:last-child { margin-right:0;}
